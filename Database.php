...
class Database {
    ...
    function connect() {
        $this->dblink = mysqli_connect('localhost', 'u201800167', 'u201800167', 'db201800167') or die('CAN NOT CONNECT');
    }
...
class Database {
    ...
    function connect() {
        $this->dblink = mysqli_connect('localhost', 'u202001312', 'u202001312', 'db202001312') or die('CAN NOT CONNECT');
    }
